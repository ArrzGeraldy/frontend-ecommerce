...
import type { CartItemType, CartListProps } from "@/types";

const DesktopCartList = ({ items, handleOpenDialog }: CartListProps) => {
  return (
        ...
        >
          <div className="flex gap-4  w-full col-span-4">
            ...
            <div className="flex flex-col justify-between">
              ...
              <button
                onClick={() =>
                  handleOpenDialog(cart.id, cart.product_variant.product.name)
                }
                className="w-fit text-xs font-medium text-red-600 dark:text-red-400"
              >
                Delete
              </button>
            </div>
